    ...
    <footer className="border-t border-white/5 bg-slate/40">
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-14 sm:grid-cols-2 lg:grid-cols-4 lg:px-8">
        <div>
          ...
          <p className="mt-3 text-sm text-frost/50">
        ...
        <div>
          <h4 className="text-sm font-semibold text-frost/80">Quick Links</h4>
          <ul className="mt-3 space-y-2 text-sm text-frost/50">
        ...
        <div>
          <h4 className="text-sm font-semibold text-frost/80">Resources</h4>
          <ul className="mt-3 space-y-2 text-sm text-frost/50">
        ...
        <div>
          <h4 className="text-sm font-semibold text-frost/80">SDG Alignment</h4>
          <p className="mt-3 text-sm text-frost/50">
      ...
      <div className="border-t border-white/5 py-6 text-center text-xs text-frost/30">
