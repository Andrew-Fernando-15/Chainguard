...
export default function Roles() {
  return (
    <div className="mx-auto max-w-6xl px-5 py-12 lg:px-8">
      ...
      <p className="mt-1 text-sm text-frost/50">Every account is scoped to exactly what its role needs — nothing more.</p>
      ...
      <div className="mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {roles.map((r, i) => (
          ...
          >
            ...
            <ul className="mt-4 space-y-2 text-sm text-frost/60">
              {r.permissions.map((p) => (
